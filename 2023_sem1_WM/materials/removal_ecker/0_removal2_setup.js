...
var removal2_updating_loop_01 = {
  ...
  timeline_variables: [
{encoding: ['Q', 'G', 'R'], interval_empty: ['1800', '1800', '500'], interval_cue: ['1500', '1500', '1500'], position: ['2', '1', '0'], letter: ['S', 'F', 'L'], length: 2, correct: ['L', 'F', 'S']},
]
}
...
var removal2_updating_loop_02 = {
  ...
  timeline_variables: [
    {encoding: ['M', 'V', 'C'], interval_empty: ['500', '1800', '1800', '500', '500', '500', '500', '1800', '500', '1800'], interval_cue: ['1500', '1500', '1500', '200', '1500', '200', '200', '1500', '1500', '200'], position: ['0', '0', '2', '0', '0', '2', '0', '2', '2', '0'], letter: ['W', 'B', 'U', 'O', 'E', 'A', 'P', 'X', 'S', 'K'], length: 9, correct: ['K', 'v', 'S']},
]
}
...
var removal2_updating_loop_05 = {
  ...
  timeline_variables: [
 {encoding: ['T', 'R', 'A'], interval_empty: ['500', '1800', '500', '500', '500', '500', '500', '1800'], interval_cue: ['1500', '200', '200', '200', '1500', '1500', '200', '1500'], position: ['1', '2', '2', '2', '1', '0', '1', '0'], letter: ['N', 'Z', 'K', 'P', 'L', 'D', 'X', 'O'], length: 7, correct: ['O', 'X', 'P']},
  ]
};
...
var removal2_updating_loop_07 = {
  ...
  timeline_variables: [
    {encoding: ['Q', 'C', 'Y'], interval_empty: ['1800', '500', '500', '500', '500', '500', '500', '1800', '1800', '500', '1800', '500', '500', '1800', '500'], interval_cue: ['200', '200', '200', '1500', '200', '200', '200', '200', '200', '200', '200', '1500', '200', '1500', '1500'], position: ['2', '1', '0', '2', '1', '2', '1', '1', '1', '0', '0', '2', '2', '1', '1'], letter: ['I', 'J', 'U', 'K', 'O', 'E', 'M', 'W', 'Z', 'L', 'R', 'V', 'B', 'X', 'S'], length: 14, correct: ['R', 'S', 'B']},
]
}
...
var removal2_updating_loop_08 = {
  ...
  timeline_variables: [
    {encoding: ['Z', 'K', 'M'], interval_empty: ['500', '500', '1800', '500', '500', '500', '500', '500', '1800', '1800', '1800', '1800', '1800', '500', '1800', '1800', '500', '500', '1800', '500', '500'], interval_cue: ['200', '200', '1500', '1500', '1500', '200', '1500', '1500', '200', '1500', '200', '200', '1500', '1500', '200', '200', '200', '200', '1500', '200', '200'], position: ['0', '0', '1', '0', '0', '0', '0', '0', '0', '1', '2', '1', '1', '2', '2', '1', '1', '2', '0', '2', '0'], letter: ['D', 'I', 'A', 'Q', 'U', 'X', 'L', 'Y', 'S', 'G', 'P', 'H', 'W', 'T', 'F', 'O', 'R', 'V', 'C', 'B', 'J'], length: 20, correct: ['J', 'R', 'B']},
]
}
...
var removal2_updating_loop_11 = {
  ...
  timeline_variables: [
    {encoding: ['J', 'X', 'B'], interval_empty: ['500', '500', '500', '500', '1800', '1800', '500', '1800', '500', '1800', '1800'], interval_cue: ['1500', '200', '200', '1500', '200', '1500', '1500', '1500', '200', '1500', '1500'], position: ['0', '1', '0', '2', '1', '2', '2', '2', '2', '2', '1'], letter: ['G', 'M', 'R', 'K', 'S', 'U', 'F', 'P', 'W', 'A', 'T'], length: 10, correct: ['R', 'T', 'A']},
]
}

var removal2_updating_loop_12 = {
  timeline: [removal2_encoding, removal2_emptyscreen, removal2_positioncue, removal2_newletter],
  loop_function: function(){
    if(trial_count == jsPsych.timelineVariable('length')){
      trial_count = 0
  ...
  timeline_variables: [
    {encoding: ['W', 'F', 'C'], interval_empty: ['1800', '500', '1800', '1800'], interval_cue: ['200', '200', '200', '1500'], position: ['2', '2', '1', '2'], letter: ['X', 'U', 'Y', 'S'], length: 3, correct: ['w', 'Y', 'S']},
]
}
