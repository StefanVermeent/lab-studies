...
var flanker_instructions = {
  ...
  pages: [
    "<p style = 'text-align: center;'>"+
      "In dit spel ziet u steeds vijf gezichten, zoals hieronder:<br><br><br>" +
      "<div>" + left_m+left_m+left_m+left_m+left_m + "</div><br><br><br>" +
      "Uw taak is om de richting van het <strong>MIDDELSTE GEZICHT</strong> aan te geven.<br><br><br>",
     ...
     "<p style = 'text-align: center;'>"+
      ...
      "<p style = 'text-align: center;'>"+
      "Uw taak is <i>altijd</i> om de richting van het middelste gezicht te bepalen. De andere gezichten moet u <i>altijd</i> negeren.<br><br>" +
...
var flanker_end = {
  ...
  stimulus:
  "Goed gedaan!<br><br>" +
  "U bent nu klaar met het <strong>Gezichten</strong> spel.<br><br>" +
